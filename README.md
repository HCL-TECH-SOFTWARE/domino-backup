...
Officialy support for the Domino Backup feature and its configuration is provided to customers with a valid product license with subscription and support.
